// const URLProfile = 'http://blogs.csm.linkpc.net/api/v1'
// let display = document.getElementById('display')
// getData()
// function getData() {
//     fetch(`${URLProfile}/auth/profile`, {
//         method: "GET",
//         headers: {
...
//                             <div>
//                             <p class="text-secondary mb-1"><strong>ID:</strong> ${user.id}</p>
...
//                                 <div class="fw-semibold">${new Date(user.registeredAt).toLocaleDateString()}</div>
//                                 <br>
...
//         fetch(`${URLProfile}/profile/avatar`, {
//             method: 'POST',
//             headers: {
//                 'Authorization': `Bearer ${localStorage.getItem('authToken')}`
//             },
